...
export const timeslots = [
  ...
  {
    id: "timeslot-2",
    startTime: new Date("April 23, 2023 10:00:00"),
    endTime: new Date("April 23, 2023 10:40:00"),
    unavailableDates: [],
    volunteerBookings: [
      {
        id: "volunteer-booking-1",
        title: "Volunteer 1",
        date: new Date("April 23, 2023 10:00:00"),
  ...
  {
    id: "timeslot-5",
    startTime: new Date("May 26, 2023 14:10:00"),
    endTime: new Date("May 26, 2023 14:40:00"),
    unavailableDates: [],
    volunteerBookings: [
      {
        id: "vol-booking-1",
        title: "Volunteer 1",
        date: new Date("May 26, 2023 14:10:00"),
        timeslotId: "timeslot-1",
        userId: "volunteer-1",
        description: "Volunteer booking for timeslot 1",
      },
